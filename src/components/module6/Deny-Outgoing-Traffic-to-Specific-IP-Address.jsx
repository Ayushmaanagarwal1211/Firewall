...
function Deny_Outgoing_Traffic_to_Specific_IP_Address() {
    ...
    <div style={{ padding: '20px' }}>
      ...
      <div style={{display:"flex",gap:"30px",flexDirection:"row",justifyContent:"center",alignItems:"center"}}  className='w-[100%] flex flex-col items-center mt-[30px] gap-[40px]'> 
        ...
        <input
          ...
          style={{ marginLeft: '10px' }}
        />
      <button onClick={handleDenyOutgoingTraffic} style={{ marginTop: '10px' }}>
...
export default Deny_Outgoing_Traffic_to_Specific_IP_Address;
